...
ggsave("average daily traffic flow.jpg", width = 6, height = 4.5)
...
ggsave("traffic counts.jpg", width = 5, height = 3)
...
ggsave("traffic counts by station.jpg", width = 6.5, height = 4.5)
...
ggsave("no2 by year.jpg", width = 8.5, height = 4)
